...
export const loginUser = async (email, senha) => {
    ...
    try {
        const response = await axios.post('http://192.168.0.2:8000/user/login', userData);
...
export const signUp = async (dataUser) => {
    ...
    try {
        const response = await axios.post('http://192.168.0.2:8000/user/cadastro', dataUser);
...
export const recoverPass = async (numberUser) => {
    ...
    try {
        ...
        const response = await axios.post('http://192.168.0.2:8000/user/enviasmsvalidacao', data);
        // console.log(response.data);
...
export const changeTelefone = async (numberUser) => {
    ...
    try {
        ...
        const response = await axios.post('http://192.168.0.2:8000/user/enviasmsvalidacaotroca', data);
        console.log(response.data);
...
export const verificateSms = async (code, idSms) => {
    ...
    const response = await axios.post('http://192.168.0.2:8000/user/smsvalidacao', dataSms);
...
export const verificateSmsTelefone = async (code, idSms, telefoneUser, idUser) => {
    ...
    const response = await axios.post('http://192.168.0.2:8000/user/smsvalidacaotelefone', dataSms);
